...
export class TransactionService {
   ...
   obtenerTransacciones(productoId:number,desde:number,limite:number): Observable<RespuestaGenerica<TransaccionVerDTO[]>> {
     return this.http.get<RespuestaGenerica<TransaccionVerDTO[]>>(`${this.apiUrl}?ProductoId=${productoId}&desde=${desde}&limite=${limite}`);
   }
   ...
   editarTransaccion(id:number,editBody:TransaccionEditarDTO): Observable<RespuestaGenerica<TransaccionVerDTO>> {
